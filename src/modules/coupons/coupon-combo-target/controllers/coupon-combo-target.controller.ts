...
export class CouponComboTargetController {
  constructor(private readonly couponComboTargetService: CouponComboTargetService) {}
  ...
  @ApiResponse({ status: 409, description: 'El combo ya está asignado o el cupón es global' })
  async create(
