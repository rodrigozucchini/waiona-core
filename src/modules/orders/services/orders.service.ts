import {
  ...
  export class OrdersService {
    ...
    async create(user: UserEntity, dto: CreateOrderDto): Promise<OrderEntity> {
      const now = new Date();
      ...
      if (dto.couponCode) {
        ...
        // 🔥 corregido — usar couponId y userId en lugar de relaciones
      ...
      if (coupon) {
        ...
        // 🔥 corregido — usar IDs en lugar de relaciones
